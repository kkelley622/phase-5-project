...
const AppointmentEdit = ({ loading }) => {
    ...
    }, [loggedIn, loading, navigate, appointments, id, app]);
  ...
  return (
    <>
        <h1>{app ? `Edit Your Appointment with ${app.provider.first_name} ${app.provider.last_name}`: "This appointment does not exist"}</h1>
