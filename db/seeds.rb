...
donna = User.create(first_name: "Donna", last_name: "Kelley", dob: Date.parse('1960-11-17'), user_name: "dkelley1", pass: "bailey56" );
kevin = User.create(first_name: "Kevin", last_name: "Kelley", dob: Date.parse('1992-04-14'), user_name: "kkelley1", pass: "1234" );
...
losartan = Medication.create(name: "losartan" , dose: "50mg" , frequency: "BID", start_date: Date.parse('2021-08-23'), user: donna);
claritin = Medication.create(name: "claritin" , dose: "10mg" , frequency: "Daily", start_date: Date.parse('2010-08-23'), user: kevin);
